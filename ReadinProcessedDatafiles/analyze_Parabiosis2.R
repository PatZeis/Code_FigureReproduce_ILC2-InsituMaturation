...
PI2nd1host <- givecells(donor_number, "Para12") ## order swapped by sorting operator, here host = bottom half of the plate
...
PI2nd1don <- givecells(host_number, "Para12") ## order swapped by sorting operator, here donor = top half of the plate
