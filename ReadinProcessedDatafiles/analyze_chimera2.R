...
Chim1host1 <- givecells(CD45_2_number, "Chim1")
Chim1host2 <- givecells(CD45_2_number, "Chim1", a=c(5,6,7,8))
Chim2host1 <- givecells(CD45_2_number, "Chim2")
Chim2host2 <- givecells(CD45_2_number, "Chim2", a=c(5,6,7,8))
Chim1don1 <- givecells(CD45_1_number, "Chim1")
Chim1don2 <- givecells(CD45_1_number, "Chim1", a=c(5,6,7,8))
Chim2don1 <- givecells(CD45_1_number, "Chim2")
Chim2don2 <- givecells(CD45_1_number, "Chim2", a=c(5,6,7,8))   
   
ChimdonS1 <- givecells(CD45_2_number, "ChieldD")
ChimdonS2 <- givecells(CD45_1_number, "ChieldD")
